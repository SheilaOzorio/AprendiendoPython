...
los valores al usuario, a su vez debe pedir dos datos y esos que sean
ingresados deben ser sustituidos en el primer y segundo lugar'''
#[20, 50, 'Curso', 'Python', 3.14]

lista = [20, 50, 'Curso', 'Python', 3.14]
print('Estos son los datos de la lista', lista)

palabra1 = input('Ingrese un valor para sustituir en el espacio 1: ')
#un numero tambien puede ser una string
